...
// DTO(Data Trasfer Object) : 값 전달용 객체 -> 객체를 이용해서 여러 값을 묶어 한번에 전달하는 용도
public class StudentDTO {
		...
		// 기본 생성자 x -> 생성자가 하나도 없을 경우 컴파일러가 기본 생성자를 추가.
		// 생성자가 하나 이상 존재할 경우 -> 컴파일러가 기본 생성자 추가 안함.
		
		// 매개 변수 생성자 o -> 컴파일러가 기본 생성자를 만들지 않기 때문에 필요하면 기본 생성자를 필수 작성		
