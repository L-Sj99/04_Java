...
// Service(제공하다) : 필요한 기능(비즈니스 로직)을 제공하는 클래스

public class MemberService {
	/* 객체 배열 : 객체를 참조하는 참조형 변수를 묶음으로 다루는 것
	 * 
	 * [작성법]
	 ...
	 * - new Academy[3] : heap영역에 Academy "참조형 변수" 3칸 짜리 묶음 배열
	...
	public void method1() {
		...
		memberArr[0] = new MemberDTO("member01", "pass01", "일번 회원", 30);
		memberArr[1] = new MemberDTO("member02", "pass02", "회원 투", 22);
		memberArr[2] = new MemberDTO("member03", "pass03", "세번째 멤버", 33);
