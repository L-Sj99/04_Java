...
public class Student {
	...
	/* 필드( == 멤버 변수 ) */
	// 필드 1 : class변수( == static 변수 ) -> 클래스명.변수명 형태로 호출하기 때문에 class 변수라 한다
	...
	public String toString() {
		...
		// -> 패턴 형태의 문자열을 반환하는 메서드(printf와 비슷한데 print는 출력, String.format()은 문자열 만들어서 반환
