...
public class Account {
	...
	/* 캡슐화
	 * 1) 객체의 속성, 기능을 하나로 묶음
	 * 2) 외부로 부터의 직접 접근을 제한(차단) -> 내부가 보이지 않음(정보 은닉 효과)
	 * 
	 * [직접 접근을 제한하는 방법]
	 ...
	 * 
	 * 	* 기본적으로 모든 클래스의 속성은 private을 적용하는 것이 원칙 *
	 */
	...
	// private이 붙은 변수는 만들어진 객체에서만 사용/접근 가능
	
	// 기능(메서드)
	/* 입금 기능
	 * 매개 변수(Parameter) : 메서드 호출 시 전달받은 값을 저장하는 변수
	...
	// getName() 호출하면 String 자료형을 반환할거야
