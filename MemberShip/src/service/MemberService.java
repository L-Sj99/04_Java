...
public interface MemberService {
	...
	// 인터페이스의 메서드는 모두 추상 메서드
	// - public abstract method (중요)
	// - default method
	
	 /* 전달 받은 이름, 휴대폰 번호를 이용해서 회원 추가
	  * 단, 목록에 있는 회원 중 같은 번호의 회원이 존재하면 false반환 / 없으면 가입 후 true 반환
	 * @param name
	 * @param phone
	 * @return true / false
	 */
	 ...
	 * - 동명이인이 존재하면 모두 조회
	 * @param searchName
	 * @return searchName (저장된 요소 0개 이상)
	 */
	 ...
	 * @throws IOException
	 */
	public abstract String updateMember(Member target, String phone) throws IOException;
