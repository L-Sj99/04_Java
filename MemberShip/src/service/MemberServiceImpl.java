...
public class MemberServiceImpl implements MemberService{
	...
	// 기본 생성자
	// - MemberServiceImpl 객체 생성 시 MemberDaoImpl 객체도 생성
	...
	public boolean addMember(String name, String phone) throws IOException{
		...
		// 2) 중복이 아닌 경우 입력 받은 정보를 이용해 Member 객체를 생성하고 DAO에 전달하여 파일에 저장
	...
	public List<Member> selectName(String searchName){
		...
		// memberList에 저장된 요소(회원) 중 이름이 같은 회원을 찾아서 검색 결과를 저장할 별도 List에 추가
