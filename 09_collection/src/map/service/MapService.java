...
public class MapService {
	...
	public void test1() {
		...
		// - Hash 단어가 붙으면 빠름 -> 대신 Key 열할의 객체가 equals(), hashCode() 오버라이딩 필수
		Map<String, String> map = new HashMap<String, String>();
		
		// 1. V put(K k , V v) : Map에 K:V 한쌍을 추가, 추가 성공 시 Value가 반환됨
		...
		// 4. V remove(K k) : Map에서 Key가 일치하는 쌍을 제거, 일치하는 Key가 존재하면 Value 반환, 존재하지 않으면 null 반환
	...
	public void test2() {
		...
		// Key는 String -> 문자열만 작성
		// V는 Object -> 어떤 자료형이든 상관 없이 모든 자료형이 가능하다
