...
public interface Calculator {
	...
	// public static final을 생략해도 인터페이스에 작성된 필드는 자동으로 public static final로 인식
	int MAX_NUM = 100_000_000;
	int MIN_NUM = -100_000_000;
	
	// 메서드는 무조건 public abstract
	/* 두 수의 합을 반환, 결과는 최대 최소값을 넘을 수 없음
	 * @param a
	 * @param b
	 * @return a + b
	 */
	...
	/**
	 * 두 수의 차를 반환, 결과는 최대 최소값을 넘을 수 없음
	 * @param a
	 * @param b
	 * @return a - b
	 */
	...
	/**
	 * 두 수의 곱을 반환, 결과는 최대 최소값을 넘을 수 없음
	 * @param a
	 * @param b
	 * @return a * b
	 */
	...
	/**
	 * 두 수를 나눈 몫을 반환, 결과는 최대 최소값을 넘을 수 없음
	 * @param a
	 * @param b
	 * @return a / b
	 */
	...
	/**
	 * 두 수를 나눈 나머지 반환, 결과는 최대 최소값을 넘을 수 없음
	 * @param a
	 * @param b
	 * @return a % b
	 */
	...
	/**
	 * 2를 x만큼 거듭 제곱한 결과 반환, 결과는 최대, 최소를 넘을 수 없음
	 * @param a
	 * @param x
	 * @return a^x
	 */
