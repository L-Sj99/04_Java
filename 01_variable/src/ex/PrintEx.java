...
public class PrintEx {
	public static void main(String[] args) {
		...
		System.out.printf("%s은 %d세 %c성으로 키는 %fcm이고, 자바 공부 여부 : %b", name, age, gender, height, javaStudy);
